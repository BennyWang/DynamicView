...
public class ViewDefinitions {
    ...
    public static List<ViewDefinition> getViews() {
        ...
        builder.append("<Text text='{title}' size='20' color='black'/>");
        builder.append("<Text text='金额' margin='0 10 0 0'/>");
        builder.append("<HBox><Text text='{money}' size='28' color='black'/><Text text='元'/></HBox>");
        ...
        builder.append("<VBox background='#80E0E0E0 20 20 0 0' padding='18 18 18 10' margin='14' width='match'>");
        builder.append("<Text text='{title}' color='black'/>");
        builder.append("<Text text='还款金额' margin='0 10 0 0'/>");
        builder.append("<HBox><Text text='{money}' size='28' color='black'/><Text text='人民币'/></HBox>");
        builder.append("<Grid spanCount='2' dataSource='{items}'>");
        builder.append("<VBox margin='0 10 0 0'><Text text='{name}'/><Text text='{value}' color='black'/></VBox>");
        builder.append("</Grid>");
        builder.append("</VBox>");
